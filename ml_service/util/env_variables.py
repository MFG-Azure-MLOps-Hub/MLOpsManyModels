...
class Env(Singleton):
    ...
    def __init__(self):
        ...
        self._deploy_aci_pipeline_name = os.environ.get("DEPLOY_ACI_PIPELINE_NAME")
        ...
        self._datafile_path = os.environ.get("DATAFILE_PATH")
        ...
        self._train_storage_connection_string = os.environ.get("TRAIN_STORAGE_CONNECTION_STRING")
        self._train_storage_container = os.environ.get('TRAIN_STORAGE_CONTAINER')
        self._applicationinsights_connection_string = os.environ.get('APPLICATIONINSIGHTS_CONNECTION_STRING')
    ...
    @property
    def deploy_aci_pipeline_name(self):
        return self._deploy_aci_pipeline_name
    ...
    @property
    def train_storage_connection_string(self):
        return self._train_storage_connection_string

    @property
    def train_storage_container(self):
        return self._train_storage_container

    @property
    def applicationinsights_connection_string(self):
        return self._applicationinsights_connection_string
